...
class GameScene: SKScene {
    ...
    private func createApple() {
        ...
        var randY: CGFloat
        repeat{
            randX = CGFloat(arc4random_uniform(UInt32(gameFrameRect.maxX) - padding) + padding)}while randX > gameFrameRect.maxX || randX < gameFrameRect.minX
        repeat{
        randY = CGFloat(arc4random_uniform(UInt32(gameFrameRect.maxY) - padding) + padding)}while randY > gameFrameRect.maxY || randY < gameFrameRect.minY
